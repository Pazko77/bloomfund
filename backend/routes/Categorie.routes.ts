...
// 🔐 Routes protégées
CategorieRouter.post('/', authenticateToken, authorizeCategorieAdmin, CategorieController.createCategorie);
CategorieRouter.delete('/:id', authenticateToken, authorizeCategorieAdmin, CategorieController.deleteCategorie);
CategorieRouter.put('/:id', authenticateToken, authorizeCategorieAdmin, CategorieController.updateCategorie);
