        ...
        <div className="signup-card">
          ...
          >
            ...
            <div className={`form-group ${errors.password ? "has-error" : ""}`}>
              <div
                className={`input-wrapper password-wrapper ${focusedField === "password" ? "focused" : ""}`}
              >
                <input
                ...
                >
                  <span
                    className={`eye-icon ${showPassword ? "show-password" : ""}`}
                  ></span>
                </button>
              </div>
              {formData.password && (
            ...
            >
              <div
                className={`input-wrapper password-wrapper ${focusedField === "confirmPassword" ? "focused" : ""}`}
              >
                <input
                ...
                >
                  <span
                    className={`eye-icon ${showConfirmPassword ? "show-password" : ""}`}
                  ></span>
                </button>
              </div>
            ...
            <div
              className={`form-group checkbox-group ${errors.terms ? "has-error" : ""}`}
            >
