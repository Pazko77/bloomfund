...
export default function Connexion() {
  ...
  const handleForgotPassword = (e) => {
    e.preventDefault();
    showNotification(
      "Le lien de réinitialisation serait envoyé à votre email",
      "info",
    );
  };
    ...
    <div className="login">
      <div className="login-container">
        <div className="login-card">
          ...
          <form
            ref={formRef}
            className={`login-form ${showSuccess ? "form-hidden" : ""}`}
            id="loginForm"
          ...
          >
            ...
            <button
              type="submit"
              className={`login-btn btn ${isSubmitting ? "loading" : ""}`}
